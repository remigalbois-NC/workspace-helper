...
import { Send, Bot, User, Sparkles, LogOut, Loader2, MessageSquare, Plus } from "lucide-react";
...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (!hydrated || discussions.length === 0) return;
    saveDiscussionsToStorage(discussions);
  }, [hydrated, discussions]);
            ...
            {messages.map((m, i) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <div style={{ fontSize: "15px", lineHeight: "1.6" }} className="markdown-content">
                      <ReactMarkdown
                        remarkPlugins={[remarkGfm]}
                        components={{
                          p: ({ children }) => <p style={{ margin: "0 0 0.75em", color: "inherit" }}>{children}</p>,
                          ul: ({ children }) => (
